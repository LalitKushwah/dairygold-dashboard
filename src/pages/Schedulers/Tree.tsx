...
import { PopconfirmProps, TreeDataNode } from 'antd';
...
const SchedulersTree: React.FC<SchedulerTreeProps> = ({ confirmHandler, showModal }) => {
	const { t } = useTranslation();
	const confirmPropsValue: PopconfirmProps = {
		title: t('schedulers.popconfirmTitle'),
		description: t('schedulers.popconfirmDescription'),
		okText: t('schedulers.popconfirmOkText'),
		cancelText: t('schedulers.popconfirmCancelText'),
	};
			...
			children: [
				{
					title: (
						<Components.Popconfirm
							...
							onConfirm={() => confirmHandler('CREATE_PRODUCT', 'POST')}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_PRODUCT', 'POST')}
							icon={<SyncOutlined />}
			...
			children: [
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('CREATE_CUSTOMER', 'POST')}
							icon={<PlusCircleOutlined />}
							buttontext='schedulers.createInApp'
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_CUSTOMER', 'POST')}
							icon={<SyncOutlined />}
							buttontext='schedulers.updateInApp'
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_SALES_TREE', 'GET')}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_CUSTOMER_DASHBOARD', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_PARENT_ID', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_CUSTOMER_STATEMENT', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_CUSTOMER_PENDING_INVOICE', 'GET')}
							icon={<SyncOutlined />}
			...
			children: [
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_NON_CUSTOMER_DASHBOARD', 'GET')}
							icon={<SyncOutlined />}
							buttontext='schedulers.updateDashboard'
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('MAP_CATEGORIES_TO_SALES_EXECUTIVE', 'GET')}
							icon={<ApartmentOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('MAP_SALESMAN_TO_SALESMANAGER', 'GET')}
							icon={<ApartmentOutlined />}
			...
			children: [
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_IN_PROGRESS_ORDER_IN_ERP', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_ORDER_STATUS_BILLED_IN_APP', 'GET')}
							icon={<SyncOutlined />}
				...
				{
					title: (
						<Components.Button danger={true} className='Scheduler-button' onClick={showModal} id='delete-order'>
			...
			children: [
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_CUSTOMER_PERFORMANCE', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_SKU_PERFORMANCE', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_VAN_PERFORMANCE', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_FOCUSED_PACK', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_TGT_VS_ACHIEVE', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_INVOICE_AGAINST_ORDER', 'GET')}
							icon={<SyncOutlined />}
			...
			children: [
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_BANKS', 'GET')}
							icon={<SyncOutlined />}
				...
				},
				{
					title: (
						<Components.Popconfirm
							...
							type='primary'
							className='Scheduler-button'
							onConfirm={() => confirmHandler('UPDATE_MILK_COLLECTION_IN_ERP', 'GET')}
							icon={<SyncOutlined />}
	...
	return (
		<>
			<Components.Row>
				<Components.Col xl={12} md={12} sm={24} xs={24} xxl={12}>
					<Components.Tree treeData={LeftSideTreeData} defaultExpandAll showIcon></Components.Tree>
				</Components.Col>
				<Components.Col xl={12} md={12} sm={24} xs={24} xxl={12}>
					<Components.Tree treeData={RightSideTreeData} defaultExpandAll showIcon></Components.Tree>
				</Components.Col>
			</Components.Row>
		</>
	);
